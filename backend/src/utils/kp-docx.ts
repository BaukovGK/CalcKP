 ...
 * ещё блок условий, подписи и реквизиты — они не перенесены. Что именно и по
 * каким правилам печатает коммерческий отдел — разбор рабочего КП НТТ в
 * `doc/Эталон_КП_разбор.md` (каркас документа, грамматика наименования, девять
 * пунктов условий, список того, чего в КП быть не должно).
 *
