 ...
 * (любая роль); здесь — только редактор. Публикация, откат и архив пишутся в
 * AuditLog, и сохранение черновика тоже — со склейкой повторов (`auditRepeating`):
 * иначе технолог, правящий узел, заполнил бы журнал один.
 */
