 ...
 *
 * - без `:id` — создание новой единицы в проекте `?project=`: тип выбирается
 *   переключателем, `?type=` задаёт стартовую вкладку. Без проекта роутер
 *   ведёт к проектам (`surveyGate`, План_устранения 3.8): расчёт вне проекта
 *   не виден нигде в интерфейсе;
