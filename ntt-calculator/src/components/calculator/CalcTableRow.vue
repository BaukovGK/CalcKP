...
.sat-tag { font-size: 11.5px; color: var(--faint); white-space: nowrap; }
...
.cell {
  ...
  padding: 3px 6px; font-size: 13.5px; font-family: inherit;
}
...
.rst { background: transparent; border: none; color: var(--blue); font-size: 14.5px; padding: 0 1px; line-height: 1; }
.c-unit { font-size: 12.5px; color: var(--muted); }
.c-sum { text-align: right; font-weight: 500; }
.c-note { display: flex; align-items: center; gap: 4px; font-size: 12.5px; color: var(--faint); min-width: 0; }
.note { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.note-red { color: var(--acc); }
.rm { margin-left: auto; background: transparent; border: none; color: var(--faint); font-size: 14.5px; padding: 0 3px; }
.rm:hover { color: var(--acc); }
.was { color: var(--amber); white-space: nowrap; }
.btn-amber { border: 1px solid var(--amber); color: var(--amber); background: transparent; font-size: 12px; padding: 1px 6px; white-space: nowrap; }
.btn-plain { border: 1px solid var(--line2); color: var(--muted); background: transparent; font-size: 12px; padding: 1px 6px; white-space: nowrap; }
</style>
