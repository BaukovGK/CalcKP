...
/**
 * Высота рамы, м. В форму ОЛ не вынесена (ТЗ §5.6): подбор глубины всегда
 * берёт это значение, `DepthInput.frameHm` его лишь позволяет заменить.
 */
export const DEFAULT_FRAME_H_M = 0.16
/** Минимальный уровень жидкости насоса, м. Поля в форме ОЛ тоже нет (ТЗ §5.6). */
 ...
 * `utils/materialize-context.ts`; таблица в атмосферах, нижняя строка
 * 4 атм = 0,4 МПа).
