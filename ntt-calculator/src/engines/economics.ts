 ...
 *
 * ❓ Физический смысл константы требует уточнения у завода (doc/Вопросы_заводу.md, §1).
 */
 ...
 * а не в формовку.
 *
 * Трубы и муфты своего производства — корпуса, шахты и горловины, отрезки
 * трубы под гильзы, муфты вместо гильз — выделяются отдельной корзиной и
 * помечаются явно (`row.bucket`), поскольку по ЕИ («м», «шт») неотличимы от
 * прочих материалов.
 */
