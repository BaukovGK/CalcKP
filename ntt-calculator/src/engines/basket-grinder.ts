 ...
 * Наименования — в каноническом виде (utils/price-name.ts на бэкенде): так
 * их хранит прайс после чистки и так их приводит импорт.
 */
export const BASKET_GRINDER_ITEMS = {
  ...
  roundBar: { category: 'Металлопрокат', name: 'Круг 5 мм 12Х18Н10Т ГОСТ 5949-75', unit: 'м' },
