...
export const AUDIT_LABELS: Readonly<Record<string, string>> = {
  ...
  'estimate.survey': 'Правка опросного листа',
  ...
  'template.node.draft': 'Сохранён черновик узла',
  ...
  'template.product.draft': 'Сохранён черновик шаблона',
...
const META_LABELS: Readonly<Record<string, string>> = {
  ...
  saves: 'сохранений',
  more: 'ещё',
  createdNames: 'добавлены',
  created: 'добавлено',
  updated: 'обновлено',
  touched: 'затронуто',
  unchanged: 'без изменений',
  keptPrice: 'цена сохранена',
  skipped: 'пропущено',
  sheet: 'лист',
  oldPrice: 'было, ₽',
  newPrice: 'стало, ₽',
